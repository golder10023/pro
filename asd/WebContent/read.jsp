...
<script type="text/javascript">
	...
	function boardlike() {
		...
		$.ajax({
			url : '/asd/board/blike.action', //액션값
			type : 'post',
			data : {
				'boardnum' : boardnum
	...
	function bcomment1() {
		...
		var bcomment = document.getElementById('bcomment').value;
		var today = 'now';
		$.ajaxSettings.traditional = true;
		$.ajax({
			url : '/asd/bcomment/reply.action', //액션값
			type : 'post',
			data : {
				'boardnum' : boardnum,
				'user_m' : user_m,
			...
			success : function(data) {
				var bcomment=data.bcomment;
				var insert;
				$("#comul").append('<li class="media"><div class="media-left"><a href="#"><img class="media-object" width="64x64" src="/asd/assets/custom/images/userpic02.jpg"></a></div>'
                ...
                +'<p id="reply2">'+bcomment+'</p></div></li>');
/* 				$("#reply1").append(data.user_m);
				$("#reply2").append(data.bcomment); */
					...
					function() {
								...
								.click(
										function() {
											window
													.open("../pwdConfirm.jsp",
															"delete",
															"width=300, height=150, scrollbars=false, menubar=false, resizable=false");
										});
						$("#modify2")
								.click(
										function() {
						...
						$("#modify1").click(
								function() {
									...
									$("#cancel").show();
									$(".modifyBtn").show();
									$("#user_m, #btitle, #bcontent")
											.removeAttr("readonly");
									$("#user_m, #btitle, #bcontent").css(
											{"background-color" : "#FFFF96"});
									/* $("#user_m, #btitle, #bcontent","#bfront1").css(
						...
						$("#cancel").click(function() {
							...
							readForm.action = "/asd/board/read.action?boardnum=%{#list.boardnum}";
							readForm.submit();
						});
					});
</script>
...
<body class="">
	<!--Pre-Loader-->
	<div id="preloader">
		<img src="/asd/assets/custom/images/preloader.gif" alt="01">
	</div>

	<div id="wrapper" class="sidebar-left">

		<a href="#menu-toggle" class="" id="menu-toggle"><span class=""
		...
		<div id="sidebar-wrapper">
			<ul class="sidebar-nav">
				...
				<li class="sidebar-brand"><a href="../index.jsp"><img
						src="/asd/assets/custom/images/logo02.png" width="180" alt="logo"></a>
				</li>
				<li class="e-divider-4"></li>
				...
				<li><a href="/asd/board/list.action" class="current">MAKEUP
						TALK</a></li>
			...
			<div class="side-widget">
				<h6 class="font-accident-one-bold e-uppercase">Subscribe to
					news</h6>
				<input>
			</div>
			<div class="bottom-widget">
				<p class="small">© 2016 WATASIDAKENO MakeUp.</p>
				<p class="small">Sc Master 31, Seoul KOREA E-mail:
					watasinoMAKEUP@naver.com</p>
				<!--  <div>
		...
		<div id="page-content-wrapper" class="content-wrap">
					...
					<div class="navbar navbar-default" role="navigation">
						<div class="container-fluid padding-side-50">
							...
							<div class="navbar-header">
								<h1>
									<h1>
										<a href="../index.jsp">My Own MakeUp</a>
									</h1>
			...
			<div id="content">
						...
						<div id="slider4" class="rev_slider head-overlay"
							...
							<ul>
								...
								<li data-index="rs-266" data-transition="zoomout"
									...
									class="rev-slidebg" data-no-retina> <!--  LAYER NR. 1 -->
									...
									<div
										...
										data-lineheight="['120','100','90','80']" style="z-index: 2;">Mekeup
										Talk</div> <!-- LAYER NR. 3 -->
									<div
										...
										data-splitin=”none” data-splitout=”none”
										data-responsive_offset=”on” style="z-index: 2;">talk
										about your makeup or anything</div> <!--   LAYER NR. 4 -->
				...
				<section id="feedback-block"
					class="e-block-regular text-center bg-color01">
							...
							<div class="col-md-8 e-centered wow fadeInDown"
								...
								<s:form action="write" namespace="/board" method="post"
									...
									<input type="hidden" id="boardnum" name="boardnum"
										value="<s:property value="boardVO.boardnum"/>">

									<!-- 임시 ------------------------------------------------------------------->
									<!--섹션이 있을 경우 -------------------------------------------------------- -->
									<s:if test="#session.user_m != null">
										<div class="field">
											<input type="hidden" name="user_m" id="user_m"
												value="<s:property value="#session.user_m"/>"
												readonly="readonly">
										</div>
									...
									<s:if test="#session.user_m==null">
										<div class="field">
											<input type="text" name="user_m" id="user_m"
												value='<s:property value="boardVO.user_m"/>'
												readonly="readonly">
										</div>
									...
									<div class="field">
										<input type="text" id="bfront"
											value="<s:property value="boardVO.bfront"/> <s:property value="boardVO.btitle"/>"
											readonly="readonly">
								
											<select id="bfront1" name="bfront" required="required"  style="width:100px;height:30px; font-size: 15px;">
												<option>---</option>
												<option value="[SORU]">[SORU]</option>
												<option value="[HEGI]">[HEGI]</option>
											</select>
											<div class="e-divider-1"></div>
											
											<input type="text" id="btitle" name="btitle" value="<s:property value="boardVO.btitle"/>">
									...
									<div class="field">
										...
										<input type="text" id="btitle" name="btitle"
											value="<s:property value="boardVO.btitle"/>"
											readonly="readonly">
									</div> --%>
									...
									<div class="field">
										...
										<textarea id="bcontent" name="bcontent" rows="7" cols="30"
											readonly="readonly"><s:property
												value="boardVO.bcontent" /></textarea>
									</div>
								</s:form>
									...
									<table style="margin: auto;">
										<tr>
											<td style="width: 100px"><a
												href="/asd/board/list.action"><input type="button"
													class="btn btn-lg btn-blk" id="list" value="목록"></a></td>
											
											<%-- <s:if test="+<s:property value="#session.user_m"/>" == "+"boardVO.btitle"+"> --%>
											
											<%-- <s:property value="#session.user_m"/> --%>
											<%-- <s:property value="boardVO.btitle"/> --%>
											
											<td style="width: 100px"><input type="button"
												class="btn btn-lg btn-blk" id="modify1" size="5px"
												value="수정" /> <input type="button"
												class="btn btn-lg btn-blk" id="modify2" value="수정" /></td>
											<td style="width: 100px"><input type="button"
												class="btn btn-lg btn-blk" id="delete" value="삭제" /> <input
												type="button" class="btn btn-lg btn-blk" id="cancel"
												value="취소" /></td>
												<%-- </s:if> --%>
										</tr>
									</table>
								...
								<div>
									<form>
										<img src="../img/vlike2.JPG" width="40" height="40">&nbsp;&nbsp;&nbsp;
										<a href="#" onclick="javascript:boardlike();"><img
											src="../img/vlike1.JPG" width="40" height="40"></a><br>

										<label>&nbsp;&nbsp;save</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>like:</label>&nbsp;&nbsp;
										<label id="blike"><s:property value="boardVO.blike" /></label>
									</form>
								</div>
		...
		<section id="blogpost" class="inner-section padding-side-50">
				...
				<div class="">
                  ...
                  <!--  -->
                  <ul class="media-list" id="comul">
                  <s:iterator var="blist" value="blist" status="status">
                     <li class="media">
                        <div class="media-left">
                            ...
                            <div class="post-data">
                              <div class="post-date"><s:property value="bdate"/></div>
                              <div class="post-author" id="reply1"><a href="#"><h5><s:property value="user_m"/></h5></a></div>
                            </div>
                             <p id="reply2"><s:property value="bcomment"/></p>
                    	    </div>
                      </li>
                 	</s:iterator>
	                  </ul>
		...
		<div class="e-divider-2"></div>
				...
				<section class="e-block-short bg-color01">
					<div class="container-fluid padding-side-50">
						...
						<s:if test="#session.user_m != null">
							<s:form action="reply" namespace="/bcomment" method="post" name="replyForm1">
								<div class="row">
									<div class="col-md-4">
										<p>
											<label>Name</label> 
										<input type="text" id="user_m" name="user_m" value='<s:property value="#session.user_m"/>'
												...
												aria-invalid="false"> 
										<input type="hidden" id="boardnum1" name="boardnum" value='<s:property value="boardnum"/>' />
										</p>
									</div>
									<div class="col-md-12">
										<p>
											<label>Message</label>
											<textarea id="bcomment" name="bcomment" cols="60" rows="3"
								...
								<input type="button" class="btn btn-lg btn-blk"
									value="Post Comment" onclick="javascript:bcomment1();" />
							</s:form>
						</s:if>
				...
				<section id="blog" class="padding-side-50">
					...
					<div class="container-fluid text-center padding-side-60">
						<h3 class="font-accident-two-normal e-uppercase">Related
							Posts</h3>
						...
						<div id="posts" class="row popup-container">
								...
								<div class="item-wrap">
									<figure class="">
										<div class="popup-call">
											<a href="/asd/assets/custom/images/blog/feed/01.jpg"
												class="gallery-item"><i class="pe-7s-science"></i></a>
										</div>
										<img src="/asd/assets/custom/images/blog/feed/01.jpg"
											class="img-responsive" alt="img11" />
										<figcaption>
											<div class="post-meta">
												<span>by <a href="#!">Sam Anderson</a>,
												</span> <span>March 16, 2015</span>
											</div>
											<div class="post-header">
												<h5>
													<a href="blogpost.html">My Friend's new album design</a>
												</h5>
											</div>
											<div class="post-entry">
												<p>Aliquam gravida tincidunt congue. Pellentesque
													habitant morbi tristique senectus et netus et malesuada
													fames ac turpis egestas</p>
											</div>
											<div class="post-tag pull-left">
												<span><a href="#branding" data-filter=".branding">Branding</a>,</span><span><a
													href="#design" data-filter=".design">Design</a></span>
											</div>
											<div class="post-more-link pull-right">
												<a href="blogpost.html">More<i
													class="fa fa-long-arrow-right right"></i></a>
											</div>
										</figcaption>
									</figure>
								</div>
							...
							<div class="grid-item grid-sizer branding col-md-4 col-sm-6">
								<div class="item-wrap">
									<figure class="">
										<div class="popup-call">
											<a href="/asd/assets/custom/images/blog/feed/02.jpg"
												class="gallery-item"><i class="pe-7s-science"></i></a>
										</div>
										<img src="/asd/assets/custom/images/blog/feed/02.jpg"
											class="img-responsive" alt="img03" />
										<figcaption>
											<div class="post-meta">
												<span>by <a href="#!">Sam Anderson</a>,
												</span> <span>March 16, 2015</span>
											...
											<div class="post-header">
												<h5>
													<a href="blogpost.html">Funny Things done</a>
												</h5>
											</div>
											<div class="post-entry">
												<p>Aliquam gravida tincidunt congue. Pellentesque
							...
							<div class="grid-item branding col-md-4 col-sm-6">
								<div class="item-wrap">
									<figure class="">
										<div class="popup-call">
											<a href="/asd/assets/custom/images/blog/feed/03.jpg"
												class="gallery-item"><i class="pe-7s-science"></i></a>
										</div>
										<img src="/asd/assets/custom/images/blog/feed/03.jpg"
											class="img-responsive" alt="img11" />
										<figcaption>
											<div class="post-meta">
												<span>by <a href="#!">Sam Anderson</a>,
											...
											<div class="post-header">
												<h5>
													<a href="blogpost.html">Crazy Frod needs help</a>
												</h5>
											</div>
											<div class="post-entry">
												<p>Aliquam gravida tincidunt congue. Pellentesque
