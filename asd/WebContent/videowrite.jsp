...
function vwrite() {
	alert("업로드완료");
	var vwrite = document.getElementById("ajax-contact");
	vwrite.action = "/asd/video/vupload";
	vwrite.submit();
}
...
function vcancel() {
	...
	location.replace("/asd/video/vlist.action"); 
}
function check(){
	var user_m=document.getElementById("user_m").value;
	var vfront=document.getElementById("vfront").value;
                  ...
                  <div class="col-md-8 e-centered wow fadeInDown" data-wow-delay="0.6s" data-wow-offset="10">
                     ...
                     <form id="ajax-contact" method="post" enctype="multipart/form-data"  class="wpcf7-form">
                      ...
                      <!-- 임시 -------------------------------------------------------------------> 
                        ...
                        <div class="field">
                        <s:if test="#session.user_m =='soru' or #session.user_m =='hige' or #session.user_m =='golder1023'">
                           <input type="hidden" name="user_m" id="user_m" value='<s:property value="#session.user_m"/>'  placeholder="Id" >
                        </s:if>
                        <s:if test="#session.user_m ==null">
                       ...
                       <div class="e-divider-1"></div>
                        ...
                        <div class="field">
                       <s:if test="#session.user_m =='soru' or #session.user_m =='hige' or #session.user_m =='golder1023'">
                           <input type="hidden" name="vfront" id="vfront" value='<s:property value="#session.user_m"/>'  placeholder="Id" >
                         </s:if>
                         <s:if test="#session.user_m == null">
                        	 <input type="text" id="vfront" name="vfront"  required="required" placeholder="Front" >
                         </s:if>
                        </div>
                        ...
                        <div class="field">
                           ...
                           <input type="text" id="vtitle" name="vtitle"  required="required" placeholder="Title" >
                        </div>
                        ...
                        <div class="field">
                           ...
                           <textarea id="vcontent" name="vcontent"  required="required" placeholder="Content" rows="7" cols="30"  ></textarea>
                        </div>
                       
                       <div class="field">
                        <input type="text" readonly="readonly" placeholder="Video" >
                      	   <input type="file" name="data" id="data"  required="required" accept="video/*" >
                      </div>
                       
                        <div class="field">
                        <input type="text" readonly="readonly" placeholder="Image" >
                        <input type="file" accept="image/*" id="data2"  required="required" name="data2" >
                        </div>
                        <div class="e-divider-1"></div>
                        <div class="e-divider-2"></div>

                        <div class="field text-center">
                            <a href="#" onClick="javascript:check();"><button class="btn btn-lg btn-blk">Upload</button></a>
