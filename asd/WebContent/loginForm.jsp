...
<!--로그인 폼--------------------------------------------------------------------------------------  -->          
	...
	<s:if test="email == null">
	 <table style="height: auto; width:50%;"  align="center">
                           ...
                           <tr>
                              <td colspan="3" ><input type="text" class="form-control" id = "email"
        ...
        <input type="checkbox" value="remember-me" id="rememberMe" name="rememberMe"> Remember me
                        ...
                        <td>          </td>
                           <td  height="auto">
                              ...
                              <button class="btn btn-lg btn-primary btn-block" onclick="javascript:check();">Login</button>
                              </td>
                              <td>          </td>
                        </tr>
                        </table>
         ...
         <section id="clients" class="e-block-short bg-color01">
            <div class="container-fluid text-center padding-side-50">
               ...
               <div>
                ...
                <!--   <div class="col-xs-4 col-sm-1"><img src="assets/custom/images/clients/partners_01.png" class="img-responsive e-centered" alt="x"></div>
                  <div class="col-xs-4 col-sm-1"><img src="assets/custom/images/clients/partners_02.png" class="img-responsive e-centered" alt="x"></div>
                  <div class="col-xs-4 col-sm-1"><img src="assets/custom/images/clients/partners_03.png" class="img-responsive e-centered" alt="x"></div>
                  <div class="col-xs-4 col-sm-1"><img src="assets/custom/images/clients/partners_04.png" class="img-responsive e-centered" alt="x"></div>
                  <div class="col-xs-4 col-sm-1"><img src="assets/custom/images/clients/partners_05.png" class="img-responsive e-centered" alt="x"></div>
                  <div class="col-xs-4 col-sm-1"><img src="assets/custom/images/clients/partners_06.png" class="img-responsive e-centered" alt="x"></div>
                  <div class="col-xs-4 col-sm-1"><img src="assets/custom/images/clients/partners_07.png" class="img-responsive e-centered" alt="x"></div>
                  <div class="col-xs-4 col-sm-1"><img src="assets/custom/images/clients/partners_08.png" class="img-responsive e-centered" alt="x"></div>
                  <div class="col-xs-4 col-sm-1"><img src="assets/custom/images/clients/partners_09.png" class="img-responsive e-centered" alt="x"></div>
                  <div class="col-xs-4 col-sm-1"><img src="assets/custom/images/clients/partners_10.png" class="img-responsive e-centered" alt="x"></div>
                  <div class="col-xs-4 col-sm-1"><img src="assets/custom/images/clients/partners_11.png" class="img-responsive e-centered" alt="x"></div>
                  <div class="col-xs-4 col-sm-1"><img src="assets/custom/images/clients/partners_12.png" class="img-responsive e-centered" alt="x"></div> -->
               </div>
            </div>
         </section>
